...
a2dp_audio_ns = cg.esphome_ns.namespace("a2dp_audio")

A2DPAudioMediaPlayer = a2dp_audio_ns.class_(
    "A2DPAudioMediaPlayer", cg.Component, media_player.MediaPlayer
)
    ...
    cv.typed_schema(
        {
            "internal": cv.Schema(
                {
                    cv.GenerateID(): cv.declare_id(A2DPAudioMediaPlayer),
