...
void WallPadFan::perform()
{
    ...
    if (this->fan_->state != this->state_)
    {
        ...
        send_command(this->state_ ? this->get_command_on() : this->get_command_off());
    }
    // Speed
    else if (this->support_speed_ && this->state_ && this->speed_ != this->fan_->speed)
    {
        ...
        case 1:
            ...
            send_command(&command_speed_low_);
            break;
        case 2:
            ...
            send_command(&command_speed_medium_);
            break;
        case 3:
            ...
            send_command(&command_speed_high_);
            break;
        default:
