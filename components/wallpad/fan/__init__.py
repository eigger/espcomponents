...
from esphome.components import fan, wallpad
...
from .. import wallpad_ns, state_hex_schema, command_hex_schema, state_hex_expression, \
    command_hex_expression

DEPENDENCIES = ['wallpad']
WallPadFan = wallpad_ns.class_('WallPadFan', cg.Component)
...
CONFIG_SCHEMA = fan.FAN_SCHEMA.extend({
    cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(WallPadFan),
