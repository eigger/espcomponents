...
static const char *TAG = "bluetoothex.fan";

void BluetoothExFan::dump_config()
{
    ESP_LOGCONFIG(TAG, "BluetoothEx Fan '%s':", device_name_->c_str());
    dump_bluetoothex_device_config(TAG);
}

void BluetoothExFan::setup()
{
}

void BluetoothExFan::control(const fan::FanCall &call)
{
...
void BluetoothExFan::publish(const std::vector<uint8_t>& data)
{
