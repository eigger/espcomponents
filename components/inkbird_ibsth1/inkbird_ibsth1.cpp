#include "inkbird_ibsth1.h"
#include "esphome/core/log.h"

#ifdef USE_ESP32

namespace esphome {
namespace inkbird_ibsth1 {

static const char *const TAG = "inkbird_ibsth1";

void InkbirdIbstH1::dump_config() {
  ESP_LOGCONFIG(TAG, "Inkbird IBS TH1");
...
bool InkbirdIbstH1::parse_device(const esp32_ble_tracker::ESPBTDevice &device) {
  ...
  // for Inkbird IBS-TH1 device we expect
