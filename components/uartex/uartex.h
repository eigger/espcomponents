...
public:
    ...
    void set_on_write(std::function<(const uint8_t *data, const uint16_t len)> &&f) { this->on_write_f_ = f; }
    void set_on_read(std::function<(const uint8_t *data, const uint16_t len)> &&f){ this->on_read_f_ = f; }
...
protected:
    ...
    optional<std::function<(const uint8_t *data, const uint16_t len)>> on_write_f_{};
    optional<std::function<(const uint8_t *data, const uint16_t len)>> on_read_f_{};
