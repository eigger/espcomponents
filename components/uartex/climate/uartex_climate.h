...
public:
    ...
    void set_command_temperature(std::function<cmd_t(const float x, climate_t climate)> f) { this->command_temperature_func_ = f; }
    void set_command_humidity(std::function<cmd_t(const float x, climate_t climate)> f) { this->command_humidity_func_ = f; }
...
protected:
    ...
    std::function<cmd_t(const float x, climate_t climate)> command_temperature_func_{};
    ...
    std::function<cmd_t(const float x, climate_t climate)> command_humidity_func_{};
