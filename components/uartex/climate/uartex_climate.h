...
public:
    ...
    void set_custom_fan_modes(const std::vector<std::string> &modes) { this->custom_fan_modes_ = modes; }
    void set_custom_preset_modes(const std::vector<std::string> &modes) { this->custom_preset_modes_ = modes; }
...
protected:
    ...
    std::vector<std::string> custom_preset_modes_{};
};
